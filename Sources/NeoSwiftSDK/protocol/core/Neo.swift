...
public protocol Neo {
    ...
    func relay(_ context: ContractParametersContext) -> Request<NeoRelay, NeoRelay.RelayResult>
    ...
    func signMessage(_ message: String, _ avoidSignatureReplay: Bool) -> Request<NeoSignMessage, NeoSignMessage.SignatureSet>
    func verifyMessage(_ message: String, _ signatureHex: String, _ publicKeyHex: String, _ saltHex: String, _ avoidSignatureReplay: Bool) -> Request<NeoVerifyMessage, NeoVerifyMessage.Verification>
    func sign(_ context: ContractParametersContext) -> Request<NeoSign, ContractParametersContext>
    ...
    func getPendingValidUntilRelay() -> Request<NeoGetPendingValidUntilRelay, NeoGetPendingValidUntilRelay.PendingState>
    func getRawPendingTransaction(_ txHash: Hash256) -> Request<NeoGetRawPendingTransaction, String>
    func getPendingTransaction(_ txHash: Hash256) -> Request<NeoGetPendingTransaction, Transaction>
