...
public class PolicyContract: SmartContract {
    ...
    /// Constructs a new ``PolicyContract`` that uses the given ``NeoRpcClient/NeoRpcClient`` instance for invocations.
    /// - Parameter rpcClient: The ``NeoRpcClient/NeoRpcClient`` instance to use for invocations
    public init(_ rpcClient: NeoRpcClient) {
        super.init(scriptHash: PolicyContract.SCRIPT_HASH, rpcClient: rpcClient)
    }
