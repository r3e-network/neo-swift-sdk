...
class NeoTokenTests: XCTestCase {
    ...
    override func setUp() {
        ...
        rpcClient = .build(HttpService(urlSession: mockUrlSession))
    }
    
    public func testConstants() async throws {
        let neoToken = NeoToken(rpcClient)
    ...
    public func testGetCandidates() async throws {
        ...
        let result = try await NeoToken(rpcClient).getCandidates()
    ...
    public func testIsCandidate() async throws {
        ...
        let isCandidate = try await NeoToken(rpcClient).isCandidate(pubKey)
    ...
    public func testGetAllCandidatesIterator() async throws {
        ...
        let iterator = try await NeoToken(rpcClient).getAllCandidatesIterator()
    ...
    public func testGetCandidateVotes() async throws {
        ...
        let votes = try await NeoToken(rpcClient).getCandidateVotes(ECKeyPair.createEcKeyPair().publicKey)
    ...
    public func testVote() async throws {
        ...
        let b = try await NeoToken(rpcClient)
    ...
    public func testBuildVoteScript() throws {
        ...
        let script = try NeoToken(rpcClient).buildVoteScript(account1.getScriptHash(), pubKey)
    ...
    public func testBuildCancelVoteScript() throws {
        ...
        let script = try NeoToken(rpcClient).buildVoteScript(account1.getScriptHash(), nil)
        XCTAssertEqual(script, expectedScript)
    }
    ...
    public func testGetGasPerBlock() async throws {
        ...
        let gas = try await NeoToken(rpcClient).getGasPerBlock()
    ...
    public func testSetGasPerBlock() throws {
        ...
        let txBuilder = try NeoToken(rpcClient)
            .setGasPerBlock(gas)
    ...
    public func testGetRegisterPrice() async throws {
        ...
        let price = try await NeoToken(rpcClient).getRegisterPrice()
    ...
    public func testGetAccountState() async throws {
        ...
        let neoAccountState = try await NeoToken(rpcClient).getAccountState(account1.getScriptHash())
