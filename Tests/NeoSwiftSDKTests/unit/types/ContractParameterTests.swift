...
class ContractParameterTests: XCTestCase {
    ...
    public func testDeserializeAndSerialize() {
        ...
        assertValue(array2[1], Bytes([0x01, 0x02, 0x03]))
        assertValue(array2[2], Bytes([0x01, 0x02, 0x03]))
        assertValue(array2[3], Bytes([0x01, 0x02, 0x03]))
        ...
        XCTAssertTrue(keys.contains(Bytes([0x01, 0x02, 0x03])))
